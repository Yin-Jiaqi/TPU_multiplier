#test runtime performance under different batch
...
for size in size_list:
    input1=np.random.randint(low, high, size=[size,128,128], dtype=int)
    input2=np.random.randint(low, high, size=[size,128,128], dtype=int)
